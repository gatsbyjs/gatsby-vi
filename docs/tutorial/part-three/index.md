...
Ở phần này, bạn sẽ học về các Gatsby plugin và tạo các component "bố cục".
...
Các component bố cục được dùng cho các bộ phận của website mà bạn muốn chia sẻ giữa nhiều trang với nhau. Ví dụ, các website thường sẽ có một component bố cục ở đầu trang và cuối trang được dùng chung (trong nhiều trang khác nhau). Những thứ thông thường khác cũng được thêm vào bố cục là sidebar và/hoặc menu định hướng. Ví dụ như trang này, phần đầu trang là một phần thuộc về component bố cục của gatsbyjs.org.
...
> Đã có hàng trăm plugins rồi! Tìm hiểu thêm về [thư viện Plugin của Gatsby](/plugins/).
...
Trong phần giới thiệu về sử dụng các plugin, chúng ta sẽ cài đặt và triển khai các Gatsby plugin cho Typography.js.
...
hiệu ứng trên CSS được tạo ra bởi Typography.js dễ dàng hơn.
...
Cùng thực hiện một sự cải thiện nhanh nào! Nhiều trang web có một cột đơn văn bản được canh lề ở giữa trang. Để làm được điều này, thêm đoạn sau vào
